...
file.copy(from=system.file("SGPreports_Vignette", package = "Literasee"), to=".", recursive = TRUE)
...
message(
	...
	files to inspect, and the documents can be rendered using the Literasee functions.  The simple
