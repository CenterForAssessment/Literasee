...
```{r, cache=TRUE, echo=FALSE, include=FALSE}
	n_tbl_EOCT <- table(sgp_object@Data[YEAR==sgp.year & CONTENT_AREA %in% EOCT_subjects & VALID_CASE=='VALID_CASE']$CONTENT_AREA, sgp_object@Data[YEAR==sgp.year & CONTENT_AREA %in% EOCT_subjects & VALID_CASE=='VALID_CASE']$GRADE)
```
